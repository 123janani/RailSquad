...
RH_ASK Radio(2000,2,3);//speed,rx,tx
...
void loop() {
  ...
  if (Radio.recv(buf, &buflen))
  {
    ...
    Speed=text.substring(10+len_Lon+len_Lti);
     ...
     if(Tid == '45815472'){//if id correct do the calculation part
       ...
       //should calculate distance & arrival time
        ...
        long int RG_id=12345678;
        //String rg_id=String(RG_id);
        String arrival_Time=String(Time);
       
        String Snd_msg=RG_id+arrival_Time;
